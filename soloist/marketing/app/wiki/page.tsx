...
import { overviewContent } from './_content/overviewContent';
import { architectureContent } from './_content/architectureContent';
import { componentsContent } from './_content/componentsContent';
import { stateManagementContent } from './_content/stateManagementContent';
import { apiIntegrationContent } from './_content/apiIntegrationContent';
import { deploymentContent } from './_content/deploymentContent';
import { troubleshootingContent } from './_content/troubleshootingContent';
import { userGuideContent } from './_content/userGuideContent';
  ...
  return (
    <div className="flex h-screen bg-[#1e1e1e]">
      ...
      <main className="flex-1 overflow-auto relative">
        ...
        <button
          onClick={handleCopy}
          className="fixed top-4 right-4 z-10 flex items-center gap-2 px-3 py-2 bg-card/80 backdrop-blur-sm border border-border rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-card transition-all duration-200"
