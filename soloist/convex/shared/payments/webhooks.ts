      ...
      switch (eventType) {
        case "checkout.session.completed": {
          ...
          try {
            ...
            await ctx.runMutation(internal.shared.payments.payments.recordStripePayment, paymentData);
            ...
            try {
              ...
              await ctx.runMutation(internal.shared.users.userSubscriptions.createOrUpdateFromStripe, subscriptionData);
        ...
        case "customer.subscription.created": {
          ...
          try {
            await ctx.runMutation(internal.shared.users.userSubscriptions.createOrUpdateFromStripe, {
              userIdOrEmail: userIdentifier,
              subscriptionId: id,
              status,
        ...
        case "customer.subscription.deleted": {
          ...
          try {
            ...
            await ctx.runMutation(internal.shared.users.userSubscriptions.cancelByStripeId, {
