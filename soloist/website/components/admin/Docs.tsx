...
import { BookOpen, Calendar, Brain, BarChart3, Target, Zap, Heart, TrendingUp, Download } from "lucide-react";
...
export function DocsModal({ children }: DocsModalProps) {
  ...
  //   // For now, we'll show an alert. In the future, this could generate a PDF
  //   alert("PDF download feature coming soon! For now, you can use your browser's print function (Ctrl/Cmd + P) and save as PDF.");
  // };
      ...
      <DialogContent className="max-w-none w-[85vw] max-h-[90vh] p-0" style={{ maxWidth: '85vw', width: '85vw' }}>
        <DialogHeader className="pl-6 pt-8 pb-2">
          <div className="flex items-center gap-2 mb-2">
            ...
            <DialogTitle className="text-2xl font-bold">Soloist Pro User Guide</DialogTitle>
          </div>
          <Badge variant="outline" className="w-fit mb-2 border-blue-500 text-blue-600 font-medium">
            Get started with Pro to view the Developer Docs
          </Badge>
          {/* Download PDF Button - Commented out for now */}
          ...
          <div className="space-y-10 text-sm leading-relaxed">
            ...
            <section className="space-y-6">
              ...
              <div className="flex justify-left ml-4">
                <Image
                  src="/Docs3.svg"
                  alt="SoloPro mood tracking interface demonstration"
                  width={600}
                  height={400}
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                <h4 className="font-semibold mb-4 text-foreground">Key Benefits:</h4>
            ...
            <section className="space-y-8">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">How Soloist Works</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
              ...
              <div className="grid md:grid-cols-[3fr_4fr] gap-8 items-start">
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-foreground">Daily Logging Workflow</h4>
                ...
                <div className="flex justify-center">
                  <Image
                    src="/Docs10.svg"
                    alt="Soloist sidebar and daily log interface"
                    width={600}
                    height={500}
                    className=""
                  />
              ...
              {/* Advanced Analytics Playground */}
              <div className="grid md:grid-cols-[3fr_4fr] gap-8 items-start">
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-foreground">Advanced Analytics Playground</h4>
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                    <p>
                      <strong>1. Deep Review Analysis:</strong> Access the Playground to review your days with 
                      comprehensive depth and personalized recommendations for improvement.
                    </p>
                    <p>
                      <strong>2. Key Insights Dashboard:</strong> View detailed analytics including mood patterns, 
                      trend analysis, and behavioral correlations across your logging history.
                    </p>
                    <p>
                      <strong>3. Forecasting & Historical Reference:</strong> Explore predictive charting for upcoming days 
                      alongside historical forecast accuracy to validate and refine future predictions.
                    </p>
                  </div>
                </div>
                <div className="flex justify-center">
                  <Image
                    src="/Docs8.png"
                    alt="Soloist Playground analytics and forecasting interface"
                    width={600}
                    height={500}
                    className=""
                  />
              ...
              <div className="grid md:grid-cols-[3fr_4fr] gap-8 items-start">
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-foreground">Personalization & Settings</h4>
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                    <p>
                ...
                <div className="flex justify-center">
                  <Image
                    src="/Docs9.svg"
                    alt="Soloist user preferences and settings interface"
                    width={550}
                    height={450}
                    className="rounded-lg border border-gray-200 shadow-sm"
                  />
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Quick 30-second signup with email or GitHub. Your data is encrypted, private, and belongs to you.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-foreground">Log Your First Day</h4>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-foreground">Build Your Pattern</h4>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-foreground">Unlock Predictions</h4>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Access AI-powered forecasting, advanced analytics, and personalized recommendations to optimize your well-being.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-muted/30 rounded-lg p-6 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-semibold text-foreground">Interactive Heatmap</h4>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div className="bg-muted/30 rounded-lg p-6 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-semibold text-foreground">AI Mood Forecasting</h4>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="space-y-6">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Understanding Your Scores</h3>
                </div>
              </div>
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-indigo-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">90-100 • INDIGO</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Exceptional day with strong positive emotions, high energy, and significant achievements</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-blue-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">80-89 • BLUE</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Very good day, predominantly positive experiences and successful coping</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-sky-400 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">70-79 • SKY</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Good day, more positive than negative, manageable challenges</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-teal-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">60-69 • TEAL</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Fairly positive, some moderate challenges with adequate coping</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-green-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">50-59 • GREEN</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Balanced day, mix of ups and downs but generally steady</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-lime-400 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">40-49 • LIME</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Slightly below average, more challenges than successes</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-yellow-400 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">30-39 • YELLOW</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Difficult day with noticeable setbacks and stress</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-amber-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">20-29 • AMBER</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Very challenging day with significant negative emotions</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-orange-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">10-19 • ORANGE</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Extremely tough day, overwhelming stress or sadness</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 bg-white/50">
                    <div className="w-5 h-5 bg-rose-500 rounded-full flex-shrink-0"></div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">0-9 • ROSE</div>
                      <div className="text-sm text-gray-600 leading-relaxed">Crisis level, severe distress and inability to function</div>
                    </div>
                  </div>
                </div>
            ...
            <section className="space-y-6">
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-3 leading-relaxed">
            ...
            <section className="space-y-6">
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                ...
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 leading-relaxed">
                  <li>Email us at: <strong>msimon@acdc.digital</strong></li>
                  <li>Join our community on GitHub</li>
                  <li>Check out our FAQ section next</li>
                </ul>
              </div>
            </section>
