...
import { useQuery } from "@/hooks/convexHooks";
...
export function Sidebar({ className }: SidebarProps) {
  ...
  // Demo mode: always has subscription
  const effectiveSubscription = true;
  ...
  const handleProfileClick = () => {
    // Demo mode - profile editing disabled
    console.log("Profile modal disabled in demo");
  };
