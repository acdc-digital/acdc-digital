                  ...
                  <div className="prose prose-zinc dark:prose-invert max-w-none text-gray-900 dark:text-zinc-100 prose-headings:text-gray-900 dark:prose-headings:text-zinc-100 prose-strong:text-gray-900 dark:prose-strong:text-zinc-100 prose-code:text-gray-800 dark:prose-code:text-zinc-200 prose-code:bg-gray-100 dark:prose-code:bg-zinc-800 prose-code:px-1 prose-code:py-0.5 prose-code:rounded">
                    <ReactMarkdown
                      components={{
                        ...
                        blockquote: ({ children }) => (
                          <blockquote className="border-l-4 border-blue-200 dark:border-blue-800 pl-4 py-2 mb-3 bg-blue-50 dark:bg-blue-950/30 text-gray-700 dark:text-zinc-300 italic">
                            {children}
                          </blockquote>
                        ),
                        code: ({ children }) => (
                          <code className="bg-gray-100 dark:bg-zinc-800 text-gray-800 dark:text-zinc-200 px-1 py-0.5 rounded text-sm font-mono">
                            {children}
                          </code>
                        ),
                        pre: ({ children }) => (
                          <pre className="bg-gray-100 dark:bg-zinc-800 text-gray-800 dark:text-zinc-200 p-3 rounded mb-3 overflow-x-auto text-sm font-mono">
                            {children}
                          </pre>
                        ),
                      }}
