...
// Auto-resizing input for AI chat with toolbar system
  ...
  (
    ...
    return (
      <Textarea
        ...
        className={cn("resize-none overflow-auto transition-all", className)}
...
// ============================================================================
// PROMPT INPUT ACTIONS (Right side of toolbar for submit button)
// ============================================================================
