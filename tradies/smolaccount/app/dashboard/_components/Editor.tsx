    ...
    if (!activeTab) {
      return (
        <div className="p-4 space-y-3">
          <div className="font-sans inline-block px-4 py-1.5 bg-[#252526] border border-[#2d2d2d] rounded text-sm text-[#cccccc]">
        ...
        <div className="absolute left-8 right-16 top-0 bottom-0 overflow-hidden bg-[#1e1e1e]">
          <div className="flex h-full">
            {tabs.map((tab) => (
              ...
              >
                <span className="font-sans truncate flex-1">{tab.title}</span>
