    ...
    <div className="min-h-screen text-white overflow-x-hidden relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-accent-emerald/8 rounded-full blur-3xl animate-float"></div>
          <div className="absolute top-3/4 right-1/4 w-80 h-80 bg-accent-blue/8 rounded-full blur-3xl animate-float animate-delay-2"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-accent-purple/8 rounded-full blur-3xl animate-float animate-delay-4"></div>
          <div className="absolute top-2/3 left-1/3 w-72 h-72 bg-accent-cyan/8 rounded-full blur-3xl animate-float animate-delay-3"></div>
          <div className="absolute top-1/6 right-1/3 w-88 h-88 bg-accent-orange/8 rounded-full blur-3xl animate-float animate-delay-1"></div>
        </div>
      </div>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        /* Neutral Color Palette - #191919 Base */
        ...
        .border-primary { border-color: rgba(255, 255, 255, 0.08); }
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-3 group cursor-pointer">
                <div className="relative">
                  <div className="w-8 h-8 border border-accent-emerald/40 rounded-md flex items-center justify-center transition-all duration-300 group-hover:border-accent-emerald group-hover:bg-accent-emerald/5">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-accent-emerald">
                      <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
                      <path d="M2 17L12 22L22 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M2 12L12 17L22 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <div className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-accent-emerald rounded-full animate-pulse-glow"></div>
                </div>
                <div className="flex items-center space-x-2">
                  <h1 className="text-lg font-mono font-bold text-primary tracking-wider">AURA</h1>
                  <span className="text-xs font-mono text-accent-emerald/80 border border-accent-emerald/30 px-1.5 py-0.5 rounded">v2.1</span>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center space-x-4 text-xs font-mono">
                ...
                <div className="flex items-center space-x-1">
                  <span className="text-accent-emerald font-bold">5</span>
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="flex items-center space-x-2 ml-6 pl-6">
                ...
                <Button className="px-4 py-1.5 text-sm font-mono font-bold text-black bg-transparent border border-accent-emerald text-accent-emerald rounded hover:bg-accent-emerald hover:text-black transition-all duration-200">
                  start_building
                </Button>
              </div>
            </nav>
        ...
        <div className="bg-[#1f1f1f] px-6 py-0 ml-12 pb-1">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center space-x-2 text-xs font-mono">
              ...
              <span className="text-accent-emerald font-medium animate-pulse-glow">ready</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="animate-marquee whitespace-nowrap">
            <span className="text-sm font-medium tracking-wide">
              <span className="inline-flex items-center mr-8">
                <span className="w-2 h-2 bg-accent-emerald rounded-full mr-2 animate-pulse-glow"></span>
                <span className="text-accent-emerald font-bold">LIVE</span>
              </span>
              <span className="text-primary font-semibold">AURA SOCIAL INTELLIGENCE PLATFORM</span>
              <span className="text-quaternary mx-4">•</span>
              <span className="text-accent-blue font-semibold">5 AGENTS</span>
              <span className="text-secondary"> ACTIVE</span>
              <span className="text-quaternary mx-4">•</span>
              <span className="text-accent-purple font-semibold">EXTENSIONS</span>
              <span className="text-secondary"> FROM </span>
              <span className="text-accent-emerald font-bold">$0.10</span>
              <span className="text-quaternary mx-4">•</span>
              <span className="text-accent-orange font-semibold">FREE TIER</span>
              ...
              <span className="text-quaternary mx-4">•</span>
              <span className="text-accent-blue font-semibold">CONSOLE</span>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="platform">
        <div className="relative z-10 max-w-7xl mx-auto px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-start lg:items-start">
            
            {/* Hero Content */}
            <div className="lg:col-span-6 space-y-10 lg:pt-16">
              <div className="space-y-8">
                <div className="inline-flex items-center space-x-3 glass-card px-6 py-3 rounded-full">
                  <div className="w-2 h-2 bg-accent-emerald rounded-full animate-pulse-glow"></div>
                ...
                <div className="space-y-4">
                  <h1 className="text-hero font-black leading-none">
                    ...
                    <div className="text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient">Empire</div>
                  </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Button size="lg" className="bg-accent-emerald hover:bg-accent-emerald/90 text-black font-bold px-10 py-4 rounded-xl shadow-strong transition-all duration-300 hover-lift text-lg">
                  <Rocket className="mr-3 w-5 h-5" />
                  Launch Your Empire
                </Button>
                <Button variant="outline" size="lg" className="border-2 border-tertiary text-secondary hover:bg-secondary hover:text-primary backdrop-blur-sm px-10 py-4 rounded-xl font-bold transition-all duration-300 hover-lift text-lg">
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                <div className="glass-card rounded-xl p-6 text-center group hover:bg-secondary/20 transition-all duration-300 hover-lift">
                  <div className="text-display font-black text-primary">5+</div>
                  <div className="text-quaternary font-mono text-sm uppercase tracking-wide">AI Agents</div>
                </div>
                <div className="glass-card rounded-xl p-6 text-center group hover:bg-secondary/20 transition-all duration-300 hover-lift">
                  <div className="text-display font-black text-accent-emerald">Free</div>
                  <div className="text-quaternary font-mono text-sm uppercase tracking-wide">Core Tier</div>
                </div>
                <div className="glass-card rounded-xl p-6 text-center group hover:bg-secondary/20 transition-all duration-300 hover-lift">
                  <div className="text-display font-black text-primary">24/7</div>
                  <div className="text-quaternary font-mono text-sm uppercase tracking-wide">Active</div>
                </div>
              </div>
            </div>
            
            {/* Interactive Console Demo */}
            <div className="lg:col-span-6 lg:pt-0 lg:mt-20">
              <div className="glass-strong rounded-2xl overflow-hidden shadow-strong animate-float">
                ...
                <div className="bg-secondary border-b border-primary px-8 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-accent-emerald rounded-full animate-pulse-glow"></div>
                      <span className="text-accent-emerald font-semibold text-xs">AGENTS ACTIVE</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 h-96 overflow-hidden relative font-mono text-sm bg-primary">
                  <div className="animate-code-scroll space-y-4">
                    <div className="text-quaternary">$ aura agents status</div>
                    <div className="text-accent-emerald">✓ onboarding.agent - Active (Core/Free)</div>
                    <div className="text-accent-emerald">✓ content-creator.agent - Active (Core/Free)</div>
                    <div className="text-accent-emerald">✓ brand-strategist.agent - Active (Core/Free)</div>
                    <div className="text-accent-emerald">✓ scheduler.agent - Active (Core/Free)</div>
                    <div className="text-accent-cyan">→ analytics.agent - Extension ($0.15/report)</div>
                    
                    <div className="text-quaternary mt-6">$ aura onboard --product=&quot;AI SaaS Platform&quot;</div>
                    <div className="text-accent-purple">🤖 Onboarding Agent: Analyzing your product...</div>
                    <div className="text-accent-blue">→ Building brand persona...</div>
                    <div className="text-accent-blue">→ Researching target audience...</div>
                    <div className="text-accent-emerald">✓ Brand strategy complete</div>
                    
                    <div className="text-quaternary mt-6">$ aura content create --mode=auto</div>
                    <div className="text-accent-purple">🎨 Content Creator: Generating post ideas...</div>
                    <div className="text-accent-purple">📊 Brand Strategist: Ensuring voice consistency...</div>
                    <div className="text-accent-purple">⏰ Scheduler: Optimizing post timing...</div>
                    <div className="text-accent-emerald">✓ 7 posts scheduled for this week</div>
                    
                    <div className="text-quaternary mt-6">$ aura extension install logo-generator</div>
                    <div className="text-accent-cyan">→ Installing Logo Generator Extension...</div>
                    <div className="text-accent-cyan">→ Cost: $3.50 per generation</div>
                    <div className="text-accent-emerald">✓ Extension ready</div>
                    
                    <div className="text-quaternary mt-6">$ aura agents orchestrate --task=&quot;launch_campaign&quot;</div>
                    <div className="text-accent-orange">🧠 Orchestrator: Coordinating team...</div>
                    <div className="text-accent-orange">→ Content Creator: Preparing assets</div>
                    <div className="text-accent-orange">→ Scheduler: Planning distribution</div>
                    <div className="text-accent-orange">→ Brand Strategist: Final review</div>
                    <div className="text-accent-emerald">✓ Campaign launched successfully</div>
                    
                    <div className="text-quaternary mt-6">$ aura stats --realtime</div>
                    <div className="text-accent-blue">📈 Engagement up 247% this week</div>
                    <div className="text-accent-blue">🎯 Reach: 12.4K users</div>
                    <div className="text-accent-blue">💬 Comments: 94% positive sentiment</div>
                    <div className="text-accent-emerald">✓ All systems optimal</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center glass-card px-6 py-3 rounded-full mb-6">
              <div className="w-2 h-2 bg-accent-emerald rounded-full mr-3 animate-pulse-glow"></div>
            ...
            <h2 className="text-display font-black text-primary mb-6 leading-tight">
              ...
              <span className="block text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient">Architecture</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <CardHeader className="bg-secondary border-b border-primary p-6">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-primary font-bold text-2xl flex items-center">
                    <Shield className="mr-4 w-7 h-7 text-accent-emerald" />
                    Core Agents
                  </CardTitle>
                  <div className="bg-accent-emerald/20 px-4 py-2 rounded-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center text-sm">
                      <Users className="w-5 h-5 mr-3 text-accent-emerald" />
                      <span className="text-secondary">Onboarding Agent</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <MessageSquare className="w-5 h-5 mr-3 text-accent-emerald" />
                      <span className="text-secondary">Content Creator</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <Palette className="w-5 h-5 mr-3 text-accent-emerald" />
            ...
            <Card className="glass-card rounded-2xl overflow-hidden group hover:bg-secondary/10 transition-all duration-500 hover-lift">
              <CardHeader className="bg-secondary border-b border-primary p-6">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-primary font-bold text-2xl flex items-center">
                    <Puzzle className="mr-4 w-7 h-7 text-accent-purple" />
                    Extensions
                  </CardTitle>
                  <div className="bg-accent-purple/20 px-4 py-2 rounded-full">
                    <span className="text-accent-purple font-bold">PAY-PER-USE</span>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center text-sm">
                      <BarChart3 className="w-5 h-5 mr-3 text-accent-purple" />
                      <span className="text-secondary">Analytics Agent</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <Palette className="w-5 h-5 mr-3 text-accent-purple" />
                      <span className="text-secondary">Logo Generator</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <Search className="w-5 h-5 mr-3 text-accent-purple" />
                      <span className="text-secondary">Research Assistant</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <Grid3X3 className="w-5 h-5 mr-3 text-accent-purple" />
      ...
      <section className="py-16 bg-secondary/20" id="console">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center glass-card px-6 py-3 rounded-full mb-6">
              <div className="w-2 h-2 bg-accent-cyan rounded-full mr-3 animate-pulse-glow"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              ...
              <CardHeader className="bg-secondary border-b border-primary p-8">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-primary font-bold text-xl flex items-center">
                    <Cpu className="mr-3 w-6 h-6 text-accent-blue" />
                    AI Workflows
                  </CardTitle>
                  <div className="w-3 h-3 bg-accent-blue rounded-full animate-pulse-glow"></div>
                </div>
              </CardHeader>
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-accent-emerald font-bold">$1.75</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary">Market Research</span>
                    <span className="text-accent-emerald font-bold">$2.25</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary">Data Processing</span>
                    <span className="text-accent-emerald font-bold">$1.50</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card rounded-2xl overflow-hidden group hover:bg-secondary/10 transition-all duration-500 hover-lift">
              <CardHeader className="bg-secondary border-b border-primary p-8">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-primary font-bold text-xl flex items-center">
                    <Zap className="mr-3 w-6 h-6 text-accent-orange" />
                    Creative Tools
                  </CardTitle>
                  <div className="w-3 h-3 bg-accent-orange rounded-full animate-pulse-glow"></div>
                </div>
              </CardHeader>
              <CardContent className="p-8">
                <p className="text-secondary leading-relaxed mb-6 text-body-elegant">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-secondary">Logo Generator</span>
                    <span className="text-accent-emerald font-bold">$3.50</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary">Content Writer</span>
                    <span className="text-accent-emerald font-bold">$0.75</span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <Card className="glass-card rounded-2xl overflow-hidden group hover:bg-secondary/10 transition-all duration-500 hover-lift">
              <CardHeader className="bg-secondary border-b border-primary p-8">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-primary font-bold text-xl flex items-center">
                    <Database className="mr-3 w-6 h-6 text-accent-purple" />
                    Analytics & Data
                  </CardTitle>
                  <div className="w-3 h-3 bg-accent-purple rounded-full animate-pulse-glow"></div>
                </div>
              </CardHeader>
              <CardContent className="p-8">
                <p className="text-secondary leading-relaxed mb-6 text-body-elegant">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-accent-emerald font-bold">$1.25</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="w-12 h-12 bg-accent-blue/20 rounded-2xl flex items-center justify-center">
                  <Puzzle className="w-6 h-6 text-accent-blue" />
                </div>
                <div>
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="w-12 h-12 bg-accent-emerald/20 rounded-2xl flex items-center justify-center">
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="w-12 h-12 bg-accent-orange/20 rounded-2xl flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center bg-[#1f1f1f]/50 backdrop-blur-sm border border-[#2d2d2d] px-4 py-2 rounded-lg mb-6">
              <div className="w-2 h-2 bg-accent-emerald rounded-full mr-3 animate-pulse"></div>
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-primary mb-6 leading-tight">
              ...
              <span className="block text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient max-w-lg mx-auto">Pay What You Use</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              <CardHeader className="bg-[#1f1f1f] border-b border-[#2d2d2d] p-6">
                <div className="flex items-center justify-between mb-4">
                  <CardTitle className="text-primary font-bold text-2xl flex items-center">
                    <Zap className="mr-3 w-6 h-6 text-accent-emerald" />
                    Free
                  </CardTitle>
                  <div className="bg-accent-emerald/20 px-3 py-1 rounded-full">
                    <span className="text-accent-emerald font-bold text-sm">$0</span>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-accent-emerald/10 hover:bg-accent-emerald hover:text-black border border-accent-emerald/30 text-accent-emerald font-bold py-3 transition-all duration-300">
                    Get Started Free
                  </Button>
                </div>
              </CardContent>
            ...
            {/* Pro Tier */}
            <Card className="bg-[#1f1f1f]/50 border border-accent-purple/30 rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500 transform scale-105">
              <div className="bg-gradient-to-r from-accent-purple to-accent-cyan h-1"></div>
              <CardHeader className="bg-[#1f1f1f] border-b border-[#2d2d2d] p-6">
                <div className="flex items-center justify-between mb-4">
                  <CardTitle className="text-primary font-bold text-2xl flex items-center">
                    <Puzzle className="mr-3 w-6 h-6 text-accent-purple" />
                    Pro
                  </CardTitle>
                  <div className="bg-accent-purple/20 px-3 py-1 rounded-full">
                    <span className="text-accent-purple font-bold text-sm">POPULAR</span>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-accent-purple/10 hover:bg-accent-purple hover:text-black border border-accent-purple/30 text-accent-purple font-bold py-3 transition-all duration-300">
                    Upgrade to Pro
                  </Button>
                </div>
              </CardContent>
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              <CardHeader className="bg-[#1f1f1f] border-b border-[#2d2d2d] p-6">
                <div className="flex items-center justify-between mb-4">
                  <CardTitle className="text-primary font-bold text-2xl flex items-center">
                    <Cpu className="mr-3 w-6 h-6 text-accent-cyan" />
                    Power User
                  </CardTitle>
                  <div className="bg-accent-cyan/20 px-3 py-1 rounded-full">
                    <span className="text-accent-cyan font-bold text-sm">UNLIMITED</span>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-accent-cyan/10 hover:bg-accent-cyan hover:text-black border border-accent-cyan/30 text-accent-cyan font-bold py-3 transition-all duration-300">
                    Go Power User
                  </Button>
                </div>
              </CardContent>
          ...
          <div className="bg-[#1f1f1f]/30 border border-[#2d2d2d] rounded-lg p-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-[#1f1f1f]/50 rounded-lg p-6">
                <div className="text-2xl font-bold text-accent-emerald">~$0.003</div>
                <div className="text-sm text-secondary">500-token generation</div>
              </div>
              <div className="bg-[#1f1f1f]/50 rounded-lg p-6">
                <div className="text-2xl font-bold text-accent-purple">$3.00</div>
                <div className="text-sm text-secondary">Logo generation</div>
              </div>
              <div className="bg-[#1f1f1f]/50 rounded-lg p-6">
                <div className="text-2xl font-bold text-accent-cyan">$0.10</div>
      ...
      <section className="py-16" id="mission">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center bg-[#1f1f1f]/50 backdrop-blur-sm border border-[#2d2d2d] px-4 py-2 rounded-lg mb-6">
              <div className="w-2 h-2 bg-accent-orange rounded-full mr-3 animate-pulse"></div>
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-primary mb-6 leading-tight">
              ...
              <span className="block text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient max-w-xs mx-auto">Everyone</span>
            </h2>
            <div className="max-w-4xl mx-auto bg-[#1f1f1f]/30 border border-[#2d2d2d] rounded-lg p-6">
              <p className="text-lg text-secondary leading-relaxed">
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-3 flex items-center space-x-2">
                  ...
                  <span className="text-accent-emerald font-mono text-xs uppercase tracking-wide">Always Free</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-3 flex items-center space-x-2">
                  ...
                  <span className="text-accent-purple font-mono text-xs uppercase tracking-wide">Pay Per Use</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-3 flex items-center space-x-2">
                  ...
                  <span className="text-accent-cyan font-mono text-xs uppercase tracking-wide">Full Transparency</span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-primary mb-6 leading-tight">
              ...
              <span className="block text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient max-w-sm mx-auto">Philosophy</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              <CardHeader className="bg-[#1f1f1f] border-b border-[#2d2d2d] p-6">
                <CardTitle className="text-primary font-bold text-xl flex items-center">
                  <Cpu className="mr-3 w-5 h-5 text-accent-emerald" />
                  Technology with Purpose
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
            ...
            <Card className="bg-[#1f1f1f]/50 border border-[#2d2d2d] rounded-lg overflow-hidden group hover:bg-[#1f1f1f] transition-all duration-500">
              <CardHeader className="bg-[#1f1f1f] border-b border-[#2d2d2d] p-6">
                <CardTitle className="text-primary font-bold text-xl flex items-center">
                  <Users className="mr-3 w-5 h-5 text-accent-emerald" />
                  Innovation Through Collaboration
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
          ...
          <div className="mt-12 bg-[#1f1f1f]/30 border border-[#2d2d2d] rounded-lg p-8 text-center">
            ...
            <div className="mt-4 flex items-center justify-center space-x-2">
              <div className="w-2 h-2 bg-accent-emerald rounded-full animate-pulse"></div>
              <span className="text-accent-emerald font-mono text-xs uppercase tracking-wide">ACDC Digital Philosophy</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-8 text-center">
          <div className="bg-[#1f1f1f]/30 border border-[#2d2d2d] rounded-lg p-8">
            <h2 className="text-4xl lg:text-5xl font-black text-primary mb-6">
              Ready to Build with <span className="text-accent-emerald gradient-accent bg-clip-text text-transparent animate-gradient">AURA</span>?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-accent-emerald/10 border border-accent-emerald/20 text-accent-emerald hover:bg-accent-emerald hover:text-black font-bold px-6 py-3 text-lg transition-all duration-300">
                <Puzzle className="mr-2 w-5 h-5" />
                Start Free Today
              </Button>
              <Button variant="outline" size="lg" className="bg-accent-cyan/5 border border-accent-cyan/20 text-accent-cyan hover:bg-accent-cyan hover:text-black font-bold px-6 py-3 text-lg transition-all duration-300">
      ...
      <footer className="border-t border-primary/20 py-16">
        <div className="max-w-7xl mx-auto px-8">
          {/* Terminal Header */}
          <div className="border border-primary/30 rounded-lg mb-12">
            ...
            <div className="p-6">
              <p className="text-secondary mb-6 font-mono text-sm">
              ...
              <div className="flex space-x-6">
                <a href="#" className="text-secondary hover:text-accent-emerald transition-colors font-mono text-sm" aria-label="github">
                  <Github className="w-4 h-4 inline mr-2" />
                  github
                </a>
                <a href="#" className="text-secondary hover:text-accent-cyan transition-colors font-mono text-sm" aria-label="chat">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="border border-primary/20 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-secondary">
                <li><a href="#" className="hover:text-accent-emerald transition-colors font-mono text-sm flex items-center">
            ...
            <div className="border border-primary/20 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-secondary">
                <li><a href="#" className="hover:text-accent-purple transition-colors font-mono text-sm flex items-center">
            ...
            <div className="border border-primary/20 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-secondary">
                <li><a href="#" className="hover:text-accent-cyan transition-colors font-mono text-sm flex items-center">
            ...
            <div className="border border-primary/20 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm font-mono">
                  ...
                  <span className="text-accent-emerald">operational</span>
                </div>
                <div className="flex items-center justify-between text-sm font-mono">
                ...
                <div className="flex items-center justify-between text-sm font-mono">
                  <span className="text-secondary">uptime:</span>
                  <span className="text-accent-cyan">99.9%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-primary/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-secondary text-sm mt-4 md:mt-0 font-mono">
                <a href="#" className="hover:text-accent-emerald transition-colors">privacy_policy</a>
                <a href="#" className="hover:text-accent-purple transition-colors">terms_of_service</a>
                <a href="#" className="hover:text-accent-cyan transition-colors">license</a>
              </div>
            </div>
            
            {/* Terminal Prompt */}
            <div className="mt-6 border border-primary/20 rounded p-4">
              <div className="flex items-center text-sm font-mono">
                <span className="text-accent-emerald mr-2">$</span>
                <span className="text-secondary">echo &quot;thanks for exploring aura - happy coding!&quot;</span>
                <span className="text-accent-emerald ml-2 animate-pulse">_</span>
              </div>
            </div>
          </div>
        </div>
