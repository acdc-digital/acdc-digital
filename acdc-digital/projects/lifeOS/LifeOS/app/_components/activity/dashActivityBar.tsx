...
export function DashActivityBar({ activePanel, onPanelChange }: ActivityBarProps) {
  ...
  const handleActivityClick = (id: PanelType) => {
    ...
    // Handle todos special case - open both sidebar and tab
    if (id === 'todos') {
      openSpecialTab('todos-main', 'To Dos', 'todos');
    }
    
    // Handle research special case - open both sidebar and tab
    if (id === 'research') {
      openSpecialTab('research-main', 'Research', 'research');
    }
